...
public class Parameters {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.TeamAMainBotMarssoMougamadoubougary"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = "algorithms.TeamASecondaryBotMarssoMougamadoubougary"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.TeamBMainBotMarssoMougamadoubougary"; //class given by name; is supposed to extends robotsimulator.Brain
